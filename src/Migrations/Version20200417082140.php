 ...
 */
final class Version20200417082140 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE configuration_template (id INT AUTO_INCREMENT NOT NULL, configuration_id INT NOT NULL, is_active TINYINT(1) NOT NULL, activated_at DATETIME NOT NULL, INDEX IDX_F685A89873F32DD8 (configuration_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE configuration_template_item (id INT AUTO_INCREMENT NOT NULL, configuration_item_id INT NOT NULL, template_id INT NOT NULL, value VARCHAR(255) NOT NULL, INDEX IDX_8E8F976E9C279A80 (configuration_item_id), INDEX IDX_8E8F976E5DA0FB8 (template_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
